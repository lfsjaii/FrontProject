            ...
            {isLoading ? (
                ...
                <Card sx={{ maxWidth: 420 }}>
                    <CardActionArea onClick={() => {
                        ...
                        />
                        <CardContent>
                            <Typography gutterBottom component="div" height="5rem" sx={{ fontSize: '14px', mb: '12px', color: '#800019', fontWeight: '500' }}>
                                {data.name}
                            </Typography>
                            <Typography variant="body2" color="text.secondary" pt={3} sx={{ fontSize: '20px', color: '#800019' }}>
